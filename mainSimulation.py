...
weights = {'per':-0.00044731, 'pcr':0.00864906, 'pbr':0.00175114, 'roe':-0.00240344, 'psr':-0.00593808, 'roic':-0.00288943, 'eps':-0.00349109, 'ebit':0.00670509, 'ev_ebit':0.00138826, 'ev_sales':-0.00569519, 'ev_ebitda':-0.00497179, '당기순이익률':0.01989512, '영업이익률':0.00080209, '매출총이익률':-0.00176453, '배당수익률':-0.00224477}
